...
import {
  BlogDetailModalLauncherComponent
} from './features/blog/blog.detail.modal.launcher.component/blog.detail.modal.launcher.component';
...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'blog/:slug', component: BlogDetailModalLauncherComponent, outlet: 'modal', data: { title: 'Blog'} },

...
public class SkillCategoryTranslationAddRequestValidator : AbstractValidator<SkillCategoryTranslationAddRequest>
{
    public SkillCategoryTranslationAddRequestValidator()
    {

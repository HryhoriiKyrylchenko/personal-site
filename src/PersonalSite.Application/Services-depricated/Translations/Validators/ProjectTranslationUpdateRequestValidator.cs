...
public class ProjectTranslationUpdateRequestValidator : AbstractValidator<ProjectTranslationUpdateRequest>
{
    public ProjectTranslationUpdateRequestValidator()
    {
        RuleFor(x => x.Id)

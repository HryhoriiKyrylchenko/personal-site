    ...
    ISkillCategoryTranslationService
{
    ...
    {
        var skillCategoryTranslation = await Repository.GetByIdAsync(id, cancellationToken);
    ...
    {
        var skillCategoryTranslations = await Repository.ListAsync(cancellationToken);

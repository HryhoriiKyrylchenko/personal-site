...
public class GetLanguageByIdHandler : IRequestHandler<GetLanguageByIdQuery, Result<LanguageDto>>
{
    private readonly ILanguageRepository _repository;
    private readonly ILogger<GetLanguageByIdHandler> _logger;   
    private readonly IMapper<Domain.Entities.Common.Language, LanguageDto> _mapper;   
    
    public GetLanguageByIdHandler(
        ILanguageRepository repository,
        ILogger<GetLanguageByIdHandler> logger,

...
public class GetSiteInfoQueryHandler : IRequestHandler<GetSiteInfoQuery, Result<SiteInfoDto>>
{
    private readonly ILanguageRepository _languageRepository;
    private readonly ISocialMediaLinkRepository _socialMediaLinkRepository;
    private readonly IResumeRepository _resumeRepository;
    private readonly ILogger<GetSiteInfoQueryHandler> _logger;
    ...
    public GetSiteInfoQueryHandler(
        ILanguageRepository languageRepository,
        ISocialMediaLinkRepository socialMediaLinkRepository,
        IResumeRepository resumeRepository,
        ILogger<GetSiteInfoQueryHandler> logger,

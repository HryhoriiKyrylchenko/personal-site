...
public class UpdateSocialMediaLinkCommandHandler : IRequestHandler<UpdateSocialMediaLinkCommand, Result>
{
    private readonly ISocialMediaLinkRepository _repository;
    private readonly IUnitOfWork _unitOfWork;
    ILogger<UpdateSocialMediaLinkCommandHandler> _logger;

    public UpdateSocialMediaLinkCommandHandler(
        ISocialMediaLinkRepository repository, 
        IUnitOfWork unitOfWork,
        ILogger<UpdateSocialMediaLinkCommandHandler> logger)
    {

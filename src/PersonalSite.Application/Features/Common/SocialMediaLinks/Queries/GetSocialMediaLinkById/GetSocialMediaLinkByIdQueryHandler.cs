...
public class GetSocialMediaLinkByIdQueryHandler : IRequestHandler<GetSocialMediaLinkByIdQuery, Result<SocialMediaLinkDto>>
{
    private readonly ISocialMediaLinkRepository _repository;
    private readonly ILogger<GetSocialMediaLinkByIdQueryHandler> _logger;   
    private readonly IMapper<SocialMediaLink, SocialMediaLinkDto> _mapper;

    public GetSocialMediaLinkByIdQueryHandler(
        ISocialMediaLinkRepository repository,
        ILogger<GetSocialMediaLinkByIdQueryHandler> logger,

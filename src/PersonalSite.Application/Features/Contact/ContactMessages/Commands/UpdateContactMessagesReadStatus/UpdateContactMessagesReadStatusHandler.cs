...
public class UpdateContactMessagesReadStatusHandler : IRequestHandler<UpdateContactMessagesReadStatusCommand, Result>
{
    ...
    private readonly ILogger<UpdateContactMessagesReadStatusHandler> _logger;

    public UpdateContactMessagesReadStatusHandler(IContactMessageRepository repository, IUnitOfWork unitOfWork, ILogger<UpdateContactMessagesReadStatusHandler> logger)
    {

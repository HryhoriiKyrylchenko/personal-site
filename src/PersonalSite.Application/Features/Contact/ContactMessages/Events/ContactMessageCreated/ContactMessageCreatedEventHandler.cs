...
public class ContactMessageCreatedEventHandler : INotificationHandler<ContactMessageCreatedEvent>
{
    private readonly IBackgroundQueue _backgroundQueue;
    private readonly IEmailSender _emailSender;
    private readonly ILogger<ContactMessageCreatedEventHandler> _logger;
    
    private const int MaxRetries = 3;
    private const string AdminEmail = "contact@hryhoriikyrylchenko.dev";
    
    public ContactMessageCreatedEventHandler(
        IBackgroundQueue backgroundQueue,
        IEmailSender emailSender,
        ILogger<ContactMessageCreatedEventHandler> logger)
    {

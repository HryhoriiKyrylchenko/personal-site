...
public class GetContactMessageByIdHandler : IRequestHandler<GetContactMessageByIdQuery, Result<ContactMessageDto>>
{
    private readonly IContactMessageRepository _repository;
    private readonly ILogger<GetContactMessageByIdHandler> _logger;
    private readonly IMapper<ContactMessage, ContactMessageDto> _mapper;
    
    public GetContactMessageByIdHandler(
        IContactMessageRepository repository,
        ILogger<GetContactMessageByIdHandler> logger,

...
public class TrackAnalyticsEventCommandHandler : IRequestHandler<TrackAnalyticsEventCommand, Result>
{
    private readonly IAnalyticsEventRepository _repository;
    private readonly IUnitOfWork _unitOfWork;
    private readonly ILogger<TrackAnalyticsEventCommandHandler> _logger;

    public TrackAnalyticsEventCommandHandler(
        IAnalyticsEventRepository repository, 
        IUnitOfWork unitOfWork,
        ILogger<TrackAnalyticsEventCommandHandler> logger)
    {

...
public class GetBlogPageQueryHandler : IRequestHandler<GetBlogPageQuery, Result<BlogPageDto>>
{
    private const string Key = "blog";
    private readonly LanguageContext _language;
    private readonly IPageRepository _pageRepository;
    private readonly IBlogPostRepository _blogPostRepository;
    private readonly ILogger<GetBlogPageQueryHandler> _logger;
    ...
    public GetBlogPageQueryHandler(
        LanguageContext language,
        IPageRepository pageRepository,
        IBlogPostRepository blogPostRepository,
        ILogger<GetBlogPageQueryHandler> logger,

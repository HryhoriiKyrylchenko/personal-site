...
public class UpdateSkillCategoryHandler : IRequestHandler<UpdateSkillCategoryCommand, Result>
{
    ...
    private readonly ILogger<UpdateSkillCategoryHandler> _logger;

    public UpdateSkillCategoryHandler(
        ...
        ILogger<UpdateSkillCategoryHandler> logger)
    {

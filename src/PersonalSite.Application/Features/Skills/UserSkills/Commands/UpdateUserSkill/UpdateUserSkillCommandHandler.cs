...
public class UpdateUserSkillCommandHandler : IRequestHandler<UpdateUserSkillCommand, Result>
{
    private readonly IUserSkillRepository _repository;
    private readonly IUnitOfWork _unitOfWork;
    private readonly ILogger<UpdateUserSkillCommandHandler> _logger;

    public UpdateUserSkillCommandHandler(
        IUserSkillRepository repository,
        IUnitOfWork unitOfWork,
        ILogger<UpdateUserSkillCommandHandler> logger)
    {
